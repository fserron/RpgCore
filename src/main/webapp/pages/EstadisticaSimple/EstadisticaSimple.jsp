...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/EstadisticaSimple/EstadisticaSimple.js"></script>
	...
	<div class="Container">
		<table border="1">
			<tr>
				<td><form:form id="eSimpleForm" method="post"
						action="estadisticaSimple.do" modelAttribute="model">
						<div class="Opciones">
							<table border="1">
								<tr>
									<td colspan="2" align="center"><form:hidden
											path="atributo" id="atributo" />
										<div class="Atributos">
								...
								<tr>
									<td colspan=2 align="center"><form:hidden path="habilidad"
											id="habilidad" />
								...
								<tr>
									<td colspan=2 align="center"><form:hidden path="suerte"
											id="suerte" />
										<div class="Suerte">
									...
									<td align="center" colspan="2">
										<div class="Bonos">
											<span>Bono / Penalizacion (Total)</span><br> <a href="#"
												id="restarBono" class="simbolos">-</a>
											<form:input path="bono" type="text" value="0" size="1"
												style="text-align:center" id="bonoDados" />
									...
									<td colspan=2 align="center">
										<table border="1">
											<tr>
												...
												<td align="center"><span>Exitos Objetivo: </span> <a
													href="#" id="restarObjetivo" class="simbolos">-</a> <form:input
														path="objetivo" type="text" value="0" size="1"
														style="text-align:center" id="exitosObjetivo" /> <a
													href="#" id="sumarObjetivo" class="simbolos">+</a></td>
											</tr>
										</table>
									</td>
								</tr>
								<tr>
									<td colspan=2 align="center"><c:forEach var="tipo"
											items="${model.tipos}">
											<form:radiobutton id="radio_${tipo}" path="tipoTirada"
												value="${tipo}" />${tipo.description}
											</c:forEach></td>
								</tr>
								<tr>
									<td align="left"><input type="button" id="hacerTirada"
										class="standardButtonMedium" value="Tirar!" /></td>
								...
								<tr>
									<td colspan=2 align="center"><input type="hidden"
										id="eleccion" name="eleccion" /> <input type="submit"
										id="volver" class="standardButtonMedium"
										value="Volver al Menu" /></td>
								</tr>
							</table>
						</div>
					</form:form></td>
				<td rowspan=6 align="center" style="vertical-align: top">
					<div class="Resultados" style="text-align: center">
						<table id="tablaResultados" border="1">
							<tr>
								<td colspan="2"><span class="Titulo">Resultados</span></td>
							</tr>
							<tr>
